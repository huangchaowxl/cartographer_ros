...
//  cout<<"max_x   "<<probability_grid.max_x_<<"max_y   "<<probability_grid.max_y_<<"min_x   "<<probability_grid.min_x_<<"min_y   "<<probability_grid.min_y_<<endl;
  ...
  //  std::vector<uint16> cells_(200);
    string v_name;
    v_name=ch;
    v_name="/home/wxl/ros_slam/catkin_ws/src/cartographer_ros/my_package/src/"+v_name+".txt";
    outfile.open(v_name);
