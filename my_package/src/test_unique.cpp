...
void Node::AddHorizontalLaserFan(const int64 timestamp, const string& frame_id,
 ...
 /*  if(read_point==200000)

   {
       ...
       ofstream point_s("/home/wxl/ros_slam/catkin_ws/src/cartographer_ros/my_package/src/store_objection/laser_scan.txt", ios::app | ios::binary);;
       if(!point_s)
       {
                      ...
                      if(!create_record_file)
                        {
                            ...
                            record_file_name=ch;
                            record_file_name="/home/wxl/ros_slam/catkin_ws/src/cartographer_ros/my_package/src/data/"+record_file_name+".txt";
